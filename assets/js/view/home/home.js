...
export default {
    data: function () {
        return {
            ...
            slides: [
                {
                    title: 'Estilo & Transformação',
                    subtitle: 'Vivencie o luxo',
                    img: './assets/img/salao.jpeg'
                },
                {
                    title: 'Equilíbrio & Harmonia',
                    subtitle: 'Relaxamento Puro',
                    img: './assets/img/massagem.jpg'
                },
                {
                    title: 'conforto e bem-estar.',
                    subtitle: 'Universo Feminino',
                    img: './assets/img/salao1.jpeg'
                },
                {
                    title: 'Design de unhas',
                    subtitle: 'Elegância e brilho',
